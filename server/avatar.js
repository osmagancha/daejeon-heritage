...
const STAGES = [
  ...
  { name: '교생',   hanja: '校生',   need: 1900,   tier: 2, desc: '향교에 이름을 올렸다. 이제 학생이다.' },
  ...
  { name: '생원',   hanja: '生員',   need: 10100,  tier: 3, desc: '경전에 밝다는 증표를 얻었다.' },
  { name: '진사',   hanja: '進士',   need: 12700,  tier: 3, desc: '시문(詩文)에 밝다. 도포 자락이 어울린다.' },
  ...
  { name: '산림',   hanja: '山林',   need: 26700,  tier: 4, desc: '초야에 있어도 조정이 그 이름을 안다.' },
  { name: '유현',   hanja: '儒賢',   need: 31200,  tier: 4, desc: '묻고 배우러 오는 이가 끊이지 않는다.' },
  { name: '명유',   hanja: '名儒',   need: 36100,  tier: 4, desc: '한 고을을 대표하는 학자가 되었다.' },

  { name: '승문',   hanja: '承文',   need: 41400,  tier: 5, desc: '문서를 맡아 조정에 들었다. 사모를 썼다.' },
  { name: '한림',   hanja: '翰林',   need: 47100,  tier: 5, desc: '임금 곁에서 글을 짓는다.' },
